...
(function() {
	...
	maxValue: function() {
	    ...
	    mcJustinRandom.option[0] = my_array[1];
	    mcJustinRandom.option[1] = my_array[2];
	    mcJustinRandom.option[2] = my_array[3];
	    return my_array[0];
	},

    };

    window.mcJustinRandom = window.mcJustinRandom || mcJustinRandom;
}());
